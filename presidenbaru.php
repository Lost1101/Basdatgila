        ...
        <div class="container">
            ...
            <input type="hidden" name="id">
                ...
                <div class="form-group">
                    <div>
                    <label for="id_opsi">No :</label>
                    </div>
                    <input type="text" name="id_opsi" id="id_opsi" 
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_pres" id="nama_pres"
                    class="form-control"  aria-describedby="helpId" required>
                    <br><br>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_wapres" id="nama_wapres"
                    class="form-control" aria-describedby="helpId" required>
                    <br><br>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="partai" id="partai"
                    class="form-control" aria-describedby="helpId" required>
                    <br><br>
                </div>
