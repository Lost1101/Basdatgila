...
$penduduk = query("SELECT * FROM data_ktp WHERE id = $ID")[0];
        ...
        <div class="container">
            ...
            <input type="hidden" name="id" value="<?= $penduduk['id']; ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="TTL" id="TTL" required value="<?= $penduduk['TTL']; ?>" 
                    class="form-control" aria-describedby="helpId">
                    <br><br>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="jns_klmn" id="jns_klmn" required value="<?= $penduduk['jns_klmn']; ?>" 
                    class="form-control" aria-describedby="helpId">
                    <br><br>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="alamat" id="alamat" required value="<?= $penduduk['alamat']; ?>" 
                    class="form-control" aria-describedby="helpId">
                    <br><br>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="kotaorkab" id="kotaorkab" required value="<?= $penduduk['kotaorkab']; ?>" 
                    class="form-control" aria-describedby="helpId">
                    <br><br>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="sts_kawin" id="sts_kawin" required value="<?= $penduduk['sts_kawin']; ?>" 
                    class="form-control" aria-describedby="helpId">
                    <br><br>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="kewarganegaraan" id="kewarganegaraan" required value="<?= $penduduk['kewarganegaraan']; ?>" 
                    class="form-control" aria-describedby="helpId">
                    <br><br>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="golDar" id="golDar" required value="<?= $penduduk['golDar']; ?>" 
                    class="form-control" aria-describedby="helpId">
                    <br><br>
                </div>
